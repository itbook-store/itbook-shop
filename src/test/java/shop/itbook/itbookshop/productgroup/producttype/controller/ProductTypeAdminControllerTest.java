 ...
 * @since 1.0
 */
@WebMvcTest(ProductTypeAdminController.class)
class ProductTypeAdminControllerTest {
    ...
    @Autowired
    ProductTypeAdminController productTypeAdminController;
    @MockBean
    ...
    void productListFilteredByProductTypeNo() throws Exception {
        ...
        given(
            mockProductTypeService.findProductListByProductTypeNoForAdmin(any(Pageable.class),
                anyInt(), anyLong()))
            .willReturn(page);


        mvc.perform(get("/api/admin/products?productTypeNo=1&memberNo=1"))
