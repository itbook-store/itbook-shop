...
@Import(PointHistoryMemberServiceImpl.class)
class PointHistoryMemberServiceImplTest {
    ...
    @DisplayName("mypoint 조회 기능에 대한 서비스 로직이 정상적으로 동작한다.")
    @Test
    void findMyPointHistoryList() {
        PageRequest pageable = PageRequest.of(0, 10);

        // given
        given(
            pointHistoryRepository.findMyPointHistoryListResponseDto(any(), any(),
                any()))
        ...
        Page<PointHistoryListResponseDto> page =
            pointHistoryMemberService.findMyPointHistoryList(member.getMemberNo(), pageable,
                couponPointEnum);
