...
class PointHistoryMemberGetControllerTest {
    ...
    void pointHistoryCouponDetails() throws Exception {
        ...
        given(pointHistoryMemberService.findPointHistoryCouponDetailsDto(anyLong(), anyLong()))
            .willReturn(pointHistoryCouponDetailsResponseDto);

        mvc.perform(get("/api/point-histories/1/my-coupon-details/member-no/1")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON))
    ...
    void pointHistoryReviewDetails() throws Exception {
        ...
        given(
            pointHistoryMemberService.findReviewResponseDtoForPointHistoryReviewDetails(anyLong(),
                anyLong()))
            .willReturn(reviewResponseDto);

        mvc.perform(get("/api/point-histories/1/my-review-details/member-no/1")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON))
    ...
    void pointHistoryGiftDetails() throws Exception {
        ...
        given(pointHistoryMemberService.findPointHistoryGiftDetailsDto(anyLong(), anyLong()))
            .willReturn(pointHistoryGiftDetailsResponseDto);

        mvc.perform(get("/api/point-histories/1/my-gift-details/member-no/1")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON))
    ...
    void pointHistoryGradeDetails() throws Exception {
        ...
        given(pointHistoryMemberService.findPointHistoryGradeDetailsDto(anyLong(), anyLong()))
            .willReturn(pointHistoryGradeDetailsResponseDto);

        mvc.perform(get("/api/point-histories/1/my-grade-details/member-no/1")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON))
