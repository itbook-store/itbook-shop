...
public class BookmarkRepositoryImpl extends QuerydslRepositorySupport implements
    ...
    @Override
    public Page<ProductDetailsResponseDto> findAllProductDetailsByMemberNo(Pageable pageable,
                                                                           Long memberNo) {
        QBookmark qBookmark = QBookmark.bookmark;
        ...
        JPQLQuery<ProductDetailsResponseDto> productListQuery = from(qBookmark)
