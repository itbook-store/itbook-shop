 ...
 */
@Service
public class MemberGeneralOrderBeforePayment
    ...
    public MemberGeneralOrderBeforePayment(
    ...
    public void saveOrder(InfoForProcessOrderBeforePayment infoForProcessOrderBeforePayment) {
        // 주문 엔티티 인스턴스 생성 후 저장
        Order order =
