 ...
 */
@Service
public class MemberSubscriptionOrderBeforePaymentCancel
    extends AbstractMemberOrderBeforePaymentCancel {
    ...
    public MemberSubscriptionOrderBeforePaymentCancel(
        ...
        super(memberApplicableWhenOrderBeforePaymentCancel);
